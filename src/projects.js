let projects = [{
    ...
    'short_description': 'Investigate explainable AI and anomaly detection for banking system. This is the second one and has some meaning. And this is the third one and should end the description.',
    'paragraphs': [
